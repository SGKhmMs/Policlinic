    ...
    open(component: Component, id?: number | any): NgbModalRef {
        ...
        if (id) {
            this.clinicService.find(id).subscribe((clinic) => {
                clinic.beginOfWork = this.datePipe
                    .transform(clinic.beginOfWork, 'yyyy-MM-ddThh:mm');
                clinic.endOfWork = this.datePipe
                    .transform(clinic.endOfWork, 'yyyy-MM-ddThh:mm');
