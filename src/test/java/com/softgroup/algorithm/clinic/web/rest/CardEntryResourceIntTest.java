...
public class CardEntryResourceIntTest {
    ...
    public void createCardEntry() throws Exception {
        ...
        assertThat(testCardEntry.getAttachmentFile()).isEqualTo(DEFAULT_ATTACHMENT_FILE);
        assertThat(testCardEntry.getAttachmentFileContentType()).isEqualTo(DEFAULT_ATTACHMENT_FILE_CONTENT_TYPE);
        assertThat(testCardEntry.getText()).isEqualTo(DEFAULT_TEXT);
    }
    ...
    public void updateCardEntry() throws Exception {
        ...
        CardEntry testCardEntry = cardEntryList.get(cardEntryList.size() - 1);
        assertThat(testCardEntry.getAttachmentFile()).isEqualTo(UPDATED_ATTACHMENT_FILE);
        assertThat(testCardEntry.getAttachmentFileContentType()).isEqualTo(UPDATED_ATTACHMENT_FILE_CONTENT_TYPE);
        assertThat(testCardEntry.getText()).isEqualTo(UPDATED_TEXT);
    }
