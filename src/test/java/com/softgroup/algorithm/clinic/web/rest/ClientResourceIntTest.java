...
import com.softgroup.algorithm.clinic.repository.ClientRepository;
...
public class ClientResourceIntTest {
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getPassHash()).isEqualTo(DEFAULT_PASS_HASH);
        assertThat(testClient.getBirth_date()).isEqualTo(DEFAULT_BIRTH_DATE);
    ...
    public void getAllClients() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].birth_date").value(hasItem(DEFAULT_BIRTH_DATE.toString())))
    ...
    public void getClient() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients/{id}", client.getId()))
            ...
            .andExpect(jsonPath("$.birth_date").value(DEFAULT_BIRTH_DATE.toString()))
    ...
    public void updateClient() throws Exception {
        ...
        assertThat(testClient.getPassHash()).isEqualTo(UPDATED_PASS_HASH);
        assertThat(testClient.getBirth_date()).isEqualTo(UPDATED_BIRTH_DATE);
