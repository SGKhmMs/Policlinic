...
class ClientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Client entity")
        ...
        .repeat(2) {
            ...
            .post("/api/clients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "surname":"SAMPLE_TEXT", "lastname":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "adress":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "passHash":null, "birth_date":"2020-01-01T00:00:00.000Z", "photo":null}""")).asJSON
            .check(status.is(201))
